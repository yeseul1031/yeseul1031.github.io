...
const Study = () => {
    ...
    return (<div>
      ...
      <ul style={{ listStyle: "none", padding: 0 }}>
        {posts.map((post, idx) => (<li key={idx} style={{ margin: "1rem 0", border: "1px solid #ddd", padding: "1rem" }}>
            ...
            {post.description && (<p style={{ marginTop: "0.5rem", color: "#444", fontSize: "0.9rem" }}>
